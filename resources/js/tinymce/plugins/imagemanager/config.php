<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = '../../../../../../../uploads_img'; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/uploads_img"; // domain name
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../../../../uploads_img'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../../uploads_img'; // absolute or relative from this script path, required.
