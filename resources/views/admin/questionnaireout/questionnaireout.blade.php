                                ...
                                <tbody id="sortable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-primary btn-icon" href="{{ route('questionnaireout.exam',['id' => $item->survey_header_id]) }}" target="_blank">Link แบบสอบถาม</a>
                                        </td>
                                        <td>
                                            <a href="{{url('questionnaireout_edit',$item->survey_header_id)}}" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>
                                            <button type="button" class="btn btn-danger btn-sm delete-button" data-id="{{ $item->survey_header_id }}">
...
<script>
	...
	$(document).ready(function() {
				...
				$(document).on("click", ".delete-button", function(e) {
					...
					var id = $(this).data("id");
					var url = "/questionnaireout_delete/" + id;
