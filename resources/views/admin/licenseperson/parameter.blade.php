            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <h4 class="m-0">ระบบนำเข้า License Authorized</h4>
                        </div>
                        <div class="ml-3">
                            <a href="{{ route('admin') }}">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <form id="upload-excel-form" action="{{ route('license.parameter.excel') }}" method="POST"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <a href="{{ asset('images/uploads/template-file/license_authorized_temp.xlsx') }}"
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 font-weight-bold">License Authorized</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse($licenseParameter as $index => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('license.parameter.edit', $item->id) }}"
                    ...
                    button.addEventListener('click', function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                fetch(`/licenseperson/authorized/delete/${id}`, {
