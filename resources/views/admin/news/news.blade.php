							...
							<div class="card-body">
								<table id="settingTable" class="table table-striped table-bordered nowrap" style="width:100%">
									...
									<tbody id="sortable">
										...
										<tr>
											<td>
												<img src="{{asset('images/uploads/news/'.$item->cms_id.'/original/'.$item->cms_picture)}}" width="100px" height="100px">
											</td>
											<td>
												{{$item->cms_title}}
											</td>
											...
											<td>
												...
												<button type="button" class="btn btn-danger btn-sm delete-button" data-id="{{ $item->cms_id }}">
