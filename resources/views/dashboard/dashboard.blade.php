                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 custom-5-col">
                    <div class="card card-stat color-green">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-unit">
                               <a href="javascript:void(0);" onclick="openCourseListModal('completed')"> ดูบทเรียน </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 custom-5-col">
                    <div class="card card-stat color-yellow">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-unit">
                                <a href="javascript:void(0);" onclick="openCourseListModal('inProgress')"> ดูบทเรียน </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 custom-5-col">
                    <div class="card card-stat color-purple">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-unit">
                                <a href="javascript:void(0);" onclick="openCourseListModal('notStarted')"> ดูบทเรียน </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 custom-5-col">
                    <div class="card card-stat color-red">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-unit">
                               <a href="javascript:void(0);" onclick="openCourseListModal('failed')"> ดูบทเรียน </a>
                            </div>
                        </div>
