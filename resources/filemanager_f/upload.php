...
if (!empty($_FILES)) {
	...
	if (in_array(fix_strtolower($info['extension']), $ext)) {
		...
		$arr_file = ['php','html','py','js','json','txt','cs'];

		if (in_array($file_extension,$arr_file)) {
			$log_file = 'C:\Users\Administrator\Desktop\LOG_HACKER\log.txt';
			...
			$log_message = "upload tiny font IP address: ".$public_ip." - ".gethostname()." - ".$date . " - Log Using page ".$targetFile."\n";
			fwrite($handle, $log_message);
		   
			fclose($handle);
			echo "FBI coming up...";exit;
		}
