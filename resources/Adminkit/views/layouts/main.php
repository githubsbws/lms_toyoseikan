...
<body>
	...
	<div class="container-fluid fluid menu-left">
		...
		<div id="menu" class="hidden-phone hidden-print">
			...
			$criteria->compare('id',Yii::app()->session['domain']);
			$Domain = Domain::model()->find($criteria);
			...
			if ($Domain->packed == 1) {
				$this->widget('zii.widgets.CMenu',array(
					...
					'encodeLabel' => false,
					'items'=>MenuLeft_A::Menu()
				));
			}elseif ($Domain->packed == 2) {
				$this->widget('zii.widgets.CMenu',array(
					'activeCssClass'=>'active',
					'activateParents'=>true,
					'encodeLabel' => false,
					'items'=>MenuLeft_B::Menu()
				));
			}else{
				$this->widget('zii.widgets.CMenu',array(
					'activeCssClass'=>'active',
		...
		<div id="footer" class="hidden-print">
			...
			<!--  Copyright Line -->
			<div class="copy">&copy;  <?php echo date('Y'); ?> - All Rights Reserved.
			<!--  End Copyright Line -->
...
<?php
	...
	$clientScript->registerCssFile('https://foliotek.github.io/Croppie/croppie.css');
	$clientScript->registerScriptFile('https://foliotek.github.io/Croppie/croppie.js');
?>
