...
<head>
	...
	$clientScript->registerCssFile($this->assetsBase . '/theme/css/jquery.datetimepicker.css');

	$clientScript->registerCssFile($this->assetsBase . '/theme/css/sweetalert/dist/sweetalert.css');

	//
	// $clientScript->registerCssFile(Yii::app()->baseUrl.'/../cometchat/cometchatcss.php');
    //CUSTOM TEMPLATE
    $clientScript->registerCssFile($this->assetsBase.'/theme/css/custom.css');
...
<body>
	...
	<div class="container-fluid fluid menu-left">
		...
		<div class="navbar main hidden-print">
			...
			<!-- Brand -->
			<?php echo CHtml::link('BROTHER ADMIN', array('//site/index'), array('class'=>'appbrand'));?>
...
?>
	...
	<script src="<?php echo Yii::app()->baseUrl; ?>/js/sweetalert/dist/sweetalert.min.js" type="text/javascript"></script>


<script src="<?php echo Yii::app()->baseUrl; ?>/js/jquery.datetimepicker.full.min.js" type="text/javascript"></script>
