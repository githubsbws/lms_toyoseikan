				...
				<div class="innerLR">
					<div class="widget widget-tabs border-bottom-none">
						...
						<div class="widget-body">
							<div class="form">
								<form enctype="multipart/form-data" id="usability-form" action="/admin/index.php/Usability/create" method="post">
									...
									<div class="row">
										<label for="Usability_usa_title" class="required">หัวข้อวิธีการใช้งาน <span class="required">*</span></label> <input size="60" maxlength="250" class="span8" name="Usability[usa_title]" id="Usability_usa_title" type="text"> <span style="margin:0;" class="btn-action single glyphicons circle_question_mark"><i></i></span>
									...
									<div class="row">
										...
										</div><textarea rows="6" cols="50" class="span8 tinymce" name="Usability[usa_detail]" id="Usability_usa_detail" aria-hidden="true" style="display: none;"></textarea>
										<div class="error help-block">
