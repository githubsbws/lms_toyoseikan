                            ...
                            <div class="card m-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="namePupUp">หัวข้อวิดีโอ ภาษาไทย <span class="text-danger"> * </span></label>
                                        <input type="text" class="form-control" id="namePupUp" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="Link">เครดิต ภาษาไทย</label>
                                        <input type="text" class="form-control" id="link" value="" required>
                                    </div>

                                    <div class="form group">
                                        <label> ประเภทวิดีโอ ภาษาไทย </label>
                                    ...
                                    <div class="form-group mb-0 mt-3">
                                        <p class="mb-1 font-weight-bold">ชื่อไฟล์วิดีโอ ภาษาไทย</p>
