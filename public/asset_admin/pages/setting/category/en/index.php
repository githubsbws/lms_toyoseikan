        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid d-flex align-items-center">
                    <div class="">
                        <h4 class="m-0">แก้ไขข้อมูลหมวดหลักสูตร</h4>
                        ...
                        <div class="col mx-auto col-md-8 col-lg-6">
                            <div class="card m-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputText">ชื่อหมวดหลักสูตร ภาษาอังกฤษ</label>
                                        <input type="text" class="form-control" id="inputText" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="detailCategory">รายละเอียดหมวดหลักสูตร</label>
