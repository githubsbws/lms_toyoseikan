        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <h4 class="m-0">เเก้ไขวิธีการใช้งาน</h4>
                            ...
                            <div class="card m-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="namePupUp">หัวข้อวิธีการใช้งาน ภาษาไทย <span class="text-danger"> * </span></label>
                                        <input type="text" class="form-control" id="namePupUp" value="" required>
                                    </div>

                                    <div class="form-group mb-0">
                                        <label for="summernote">รายละเอียดการใช้งาน ภาษาไทย</label>
