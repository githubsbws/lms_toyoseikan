                            ...
                            <div class="card m-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="namePupUp">ชื่อหัวข้อ ภาษาไทย <span class="text-danger"> * </span></label>
                                        <input type="text" class="form-control" id="namePupUp" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="detailPopUp">รายละเอียดย่อ ภาษาไทย </label>
                                        <textarea class="form-control" id="detailPopUp" required></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="detailPopUp"> ชื่อลิ้งค์ ภาษาไทย</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        <label for="detailPopUp"> ประเภทเเกลลอรี่ ภาษาไทย</label>
                                    ...
                                    <div class="form-group mb-0">
                                        <p class="mb-1 font-weight-bold">รูปภาพ ภาษาไทย</p>
