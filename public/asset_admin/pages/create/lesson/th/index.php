            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <h4 class="m-0">เพิ่มเนื้อหาบทเรียน สำหรับภาษาไทย</h4>
                        ...
                        <div class="col mx-auto col-md-8 col-lg-6">
                            <div class="card m-0">
                                <div class="card-header bg-primary">
                                    เพิ่มเนื้อหาบทเรียน สำหรับภาษาไทย
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="nameLesson">ชื่อเนื้อหาบทเรียน ภาษาไทย</label>
                                        <input type="text" class="form-control" id="nameLesson" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="percenPassBeforeClass">เปอร์เซ็นในการผ่านของบท หลังเรียน</label>
                                    ...
                                    <div class="form-group">
                                        <label for="summernote">เนื้อหา ภาษาไทย</label>
