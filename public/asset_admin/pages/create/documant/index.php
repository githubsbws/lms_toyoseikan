                            ...
                            <div class="card m-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputText">รหัสประเภทของไฟล์ ภาษาอังกฤษ</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputText">ชื่อของไฟล์ดาวน์โหลด ภาษาอังกฤษ</label>
                                        <input type="text" class="form-control" id="inputText" value="" required>
                                    </div>
                                    <div class="form-group mb-0">
                                        <label for="inputText">รายระเอียดไฟล์ดาวน์โหลด ภาษาอังกฤษ</label>
                                        <textarea id="summernote"></textarea>
                                    </div>


                                    <div class="form-group mb-0">
                                        <p class="mb-1 font-weight-bold">ตำแหน่งที่ตั้งไฟล์ ภาษาอังกฤษ</p>
